...
const { addProduit, getProduit, getProduitById, updateProduit, deleteProduit, getProduitByCategorie } = require('../controllers/produit-controller.js');
...
router.get('/getProduitByCategorie',[verifyTokenBlacklist], getProduitByCategorie);
